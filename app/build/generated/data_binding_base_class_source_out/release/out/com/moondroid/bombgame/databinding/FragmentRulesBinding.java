...
public final class FragmentRulesBinding implements ViewBinding {
  ...
  private FragmentRulesBinding(@NonNull RelativeLayout rootView, @NonNull AppCompatImageView icBack,
  ...
  public static FragmentRulesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentRulesBinding((RelativeLayout) rootView, icBack, toolbar);
    }
